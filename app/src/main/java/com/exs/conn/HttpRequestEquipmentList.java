...
public class HttpRequestEquipmentList {
    private final static String LOG_TAG = "HTTP-REQUEST";

    public static String toHttpGetAPI(Context c,String facility_id,String token_type, String access_token) {

        String result = "";
        int getResponseCode=400;
        HttpURLConnection conn = null;
        try {
            URL url = new URL(SysPara.API_LIST_EQUIPMENT+facility_id+"/equipment");
