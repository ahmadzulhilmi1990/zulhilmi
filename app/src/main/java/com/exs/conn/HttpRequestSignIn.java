...
public class HttpRequestSignIn {
	...
	public static String toHttpPostAPI(Context c, String grant_type,String username, String password, String client_id, String client_secret, String scope) {
		...
		try {
			...
			/*Log.d(LOG_TAG,"Responbody result = "+ String.valueOf(result));
			Log.d(LOG_TAG,"Responbody output = "+ String.valueOf(output));
			Log.d(LOG_TAG,"Responbody getResponseMessage = "+ String.valueOf(conn.getResponseMessage()));
			Log.d(LOG_TAG,"Responbody getInputStream = "+ String.valueOf(conn.getInputStream()));
			Log.d(LOG_TAG,"Responbody = "+ String.valueOf(conn.getResponseCode()));*/
			//getData();
