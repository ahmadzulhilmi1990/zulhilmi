...
public class InspectionDetail extends SugarRecord {
    String inspection_detail_id;
    String equipment_id;
    String grade_d;
    String grade_c;
    String grade_v;
    ...
    String item_tag_no;
    String description;
    String finding_count;

    public InspectionDetail(){

    }

    public InspectionDetail(String inspection_detail_id, String equipment_id, String grade_d, String grade_c, String grade_v, String report_no,
